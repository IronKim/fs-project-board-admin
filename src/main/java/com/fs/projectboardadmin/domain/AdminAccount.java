package com.fs.projectboardadmin.domain;

import com.fs.projectboardadmin.domain.constant.RoleType;
import com.fs.projectboardadmin.domain.converter.RoleTypesConverter;
...
public class AdminAccount extends AuditingFields {
    ...
    @Convert(converter = RoleTypesConverter.class) // Convert 애노테이션을 이용해 문자열을 이넘값으로 변환
